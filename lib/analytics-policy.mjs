...
function slug(value, maximum, fallback) {
...
export function normalizeProductEvent(payload = {}) {
  ...
  return {
    ...
    placement: slug(payload.placement, 60, "unknown"),
    path: analyticsPath(payload.path),
    source: slug(payload.source, 80, "direct"),
    campaign: slug(payload.campaign, 120, "") || null,
  };
}
