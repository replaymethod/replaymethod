export const productEvents = new Set([
  ...
  "validation_failed", "upload_started", "upload_complete", "parse_complete", "mode_detected",
  "player_pick", "identity_captured", "processing_started", "abstention", "evidence_viewed",
  "calibration_start", "calibration_submit",
  "analysis_start", "analysis_submit",
...
export function analyticsPath(value) {
  ...
  if (/^\/(?:|analyze|beta-terms|billing\/success|climb-check|guides|league|privacy|replay-upload|reports|rocket-league|rocket-league-beta|terms|valorant)$/.test(path)) return path;
  return "/other";
}
