...
export default function PrivacyPage() {
  return <main className="legal-shell">
    ...
    <header><span>PRIVACY</span><h1>Your data should never be another hidden system.</h1><p>This notice explains what Replay Method collects when you submit a match, receive a beta report or join product updates—and how you stay in control.</p><small>Last updated: 17 August 2026</small></header>
