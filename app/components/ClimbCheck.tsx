...
export default function ClimbCheck() {
  ...
  return <main ref={mainRef} className="tool-page" data-hydrated="false">
    <nav className="tool-nav shell"><a className="brand" href="/"><span className="logo" aria-hidden="true"><ReplayMark /></span><span>replay<span>method</span></span></a><a href="/guides">Free guides</a></nav>
