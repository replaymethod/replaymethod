...
export default function GuidesPage() {
  return <main className="guide-library">
    <nav className="tool-nav shell"><a className="brand" href="/"><span className="logo">↻</span><span>replay<span>method</span></span></a><a href="/climb-check">Free Climb Check</a></nav>
