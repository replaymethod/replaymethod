...
export default function TermsPage() {
  return <main className="legal-shell">
    ...
    <header><span>WAITLIST TERMS</span><h1>No card. No hidden purchase.</h1><p>Joining the Replay Method waitlist records your interest in the private beta. These terms keep the offer clear before you submit.</p><small>Last updated: 16 August 2026</small></header>
    <div className="legal-grid">
      ...
      <article>
        ...
        <section><h2>2. Founding price</h2><p>Replay Method currently advertises a founding price of $9 per month for the first three paid months. The offer is intended for the first 100 valid founding members who receive and accept access. Duplicate, automated or fraudulent entries do not qualify. No charge is made by joining the waitlist.</p></section>
