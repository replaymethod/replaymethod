  ...
  return <main className="legal-shell">
    ...
    <div className="legal-grid">
      ...
      <article>
        ...
        <section><h2>2. Selected beta pricing</h2><p>Your first completed diagnosis is free and requires no card. Paid beta access is available only to purchasers aged 18 or over. When paid access activates, Replay Method&apos;s selected beta plans are $12 per month or $27 every three months ($9 per month effective). Each includes four successfully completed analyses every 30 days; unused analyses do not roll over. Monthly access renews monthly and the three-month plan renews every three months until canceled. Joining the waitlist does not start either plan or create a charge.</p></section>
