...
export const metadata: Metadata = {
  ...
  description: "The terms for joining the Replay Method founding-player waitlist."
};
...
export default function TermsPage() {
  return <main className="legal-shell">
    ...
    <header><span>WAITLIST TERMS</span><h1>No card. No hidden purchase.</h1><p>Joining the Replay Method waitlist records your interest in the private beta. These terms keep the offer clear before you submit.</p><small>Last updated: 18 August 2026</small></header>
    <div className="legal-grid">
      ...
      <article>
        ...
        <section><h2>2. Founding price</h2><p>Replay Method currently plans a founding price of $9 per month for the first 100 valid founding members who receive a successful free report and later choose to subscribe. The price is intended to remain $9 per month for each member&apos;s first 12 paid months while the subscription remains continuously active. Duplicate, automated or fraudulent entries do not qualify. No charge is made by joining the waitlist.</p></section>
