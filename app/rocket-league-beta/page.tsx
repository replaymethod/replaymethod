...
export default async function RocketLeagueBetaPage() {
  ...
  return <main className="rl-beta-page">
    <nav className="rl-beta-nav shell"><Link className="brand" href="/" aria-label="Replay Method home"><span className="logo">↻</span><span>replay<span>method</span></span></Link><Link href="/">Back to start</Link></nav>
