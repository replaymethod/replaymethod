...
export default async function AdminPage({ searchParams }: { searchParams: Promise<{ view?: string }> }) {
  ...
  if (user.localRole === "owner" && query.view !== "full") redirect("/local-review-owner");
